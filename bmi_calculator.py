...
if __name__ == '__main__':
    TOP = Tk()
    TOP.iconbitmap("a2fpc-4abmi-001.ico")
    TOP.bind("<Return>", calculate_bmi)
    TOP.geometry("400x400")
    TOP.configure(background="#97D0F5")
    TOP.title("BMI Calculator")
    TOP.resizable(width=True, height=True)
    LABLE = Label(TOP, bg="#307678", text="Welcome to BMI Calculator", font=("Times New Roman", 15, "bold"), pady=10)
    LABLE.place(x=55, y=0)
    LABLE1 = Label(TOP, bg="#cef0f1", text="Enter Weight (in kg):", bd=6,
                   font=("Times New Roman", 12, "bold"), pady=7)
    ...
    LABLE2 = Label(TOP, bg="#cef0f1", text="Enter Height (in cm):", bd=6,
                   font=("Times New Roman", 10, "bold"), pady=5)
